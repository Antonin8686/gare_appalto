...
APP_DOMAIN="${APP_DOMAIN:-gare.fontanebianche.today}"
VPS_IP="${VPS_IP:-82.165.176.194}"
...
CORS_ALLOWED_ORIGINS=https://${APP_DOMAIN},http://${APP_DOMAIN},http://${VPS_IP}:8080,https://${APP_DOMAIN}:8443
CSRF_TRUSTED_ORIGINS=https://${APP_DOMAIN},https://${APP_DOMAIN}:8443
